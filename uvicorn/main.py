...
@click.option(
    ...
    is_flag=False,
    flag_value=8190,
    help="Maximum allowed size of an HTTP request header field. Pass 0 to disable the check",
)
@click.option(
    "--backlog",
    type=int,
...
def main(
    ...
    run(
        ...
        limit_request_header_size=limit_request_header_size,
        backlog=backlog,
