...
async def test_invalid_upgrade(ws_protocol_cls, http_protocol_cls, unused_tcp_port):
    def app(scope):
        return None

    config = Config(
        app=app, port=unused_tcp_port, ws=ws_protocol_cls, http=http_protocol_cls
    )
...
@pytest.mark.parametrize("ws_protocol_cls", WS_PROTOCOLS)
@pytest.mark.parametrize("http_protocol_cls", HTTP_PROTOCOLS)
async def test_accept_connection(ws_protocol_cls, http_protocol_cls, unused_tcp_port):
...
async def test_supports_permessage_deflate_extension(
    ws_protocol_cls, http_protocol_cls, unused_tcp_port
):
    class App(WebSocketResponse):
        async def websocket_connect(self, message):
            await self.send({"type": "websocket.accept"})
...
@pytest.mark.parametrize("ws_protocol_cls", WS_PROTOCOLS)
@pytest.mark.parametrize("http_protocol_cls", HTTP_PROTOCOLS)
async def test_close_connection(ws_protocol_cls, http_protocol_cls, unused_tcp_port):
    class App(WebSocketResponse):
        async def websocket_connect(self, message):
...
@pytest.mark.parametrize("ws_protocol_cls", WS_PROTOCOLS)
@pytest.mark.parametrize("http_protocol_cls", HTTP_PROTOCOLS)
async def test_headers(ws_protocol_cls, http_protocol_cls, unused_tcp_port):
    class App(WebSocketResponse):
        async def websocket_connect(self, message):
...
@pytest.mark.parametrize("ws_protocol_cls", WS_PROTOCOLS)
@pytest.mark.parametrize("http_protocol_cls", HTTP_PROTOCOLS)
async def test_path_and_raw_path(ws_protocol_cls, http_protocol_cls, unused_tcp_port):
    class App(WebSocketResponse):
        async def websocket_connect(self, message):
...
@pytest.mark.parametrize("ws_protocol_cls", WS_PROTOCOLS)
@pytest.mark.parametrize("http_protocol_cls", HTTP_PROTOCOLS)
async def test_missing_handshake(ws_protocol_cls, http_protocol_cls, unused_tcp_port):
...
@pytest.mark.parametrize("ws_protocol_cls", WS_PROTOCOLS)
@pytest.mark.parametrize("http_protocol_cls", HTTP_PROTOCOLS)
async def test_duplicate_handshake(ws_protocol_cls, http_protocol_cls, unused_tcp_port):
    async def app(scope, receive, send):
...
@pytest.mark.parametrize("ws_protocol_cls", WS_PROTOCOLS)
@pytest.mark.parametrize("http_protocol_cls", HTTP_PROTOCOLS)
async def test_asgi_return_value(ws_protocol_cls, http_protocol_cls, unused_tcp_port):
    """
...
async def test_app_close(
    ws_protocol_cls, http_protocol_cls, code, reason, unused_tcp_port
):
    async def app(scope, receive, send):
        while True:
...
@pytest.mark.parametrize("ws_protocol_cls", WS_PROTOCOLS)
@pytest.mark.parametrize("http_protocol_cls", HTTP_PROTOCOLS)
async def test_client_close(ws_protocol_cls, http_protocol_cls, unused_tcp_port):
    async def app(scope, receive, send):
        while True:
            message = await receive()
            if message["type"] == "websocket.connect":
...
async def test_subprotocols(
    ws_protocol_cls, http_protocol_cls, subprotocol, unused_tcp_port
):
    class App(WebSocketResponse):
        async def websocket_connect(self, message):
